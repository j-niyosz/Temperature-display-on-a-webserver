...
SoftwareSerial ESPserial(3,2); // RX = 3, TX = 2 pour l'ESP

// Global variables
const int long serial_speed = 115200;

const char* ssid = "SEMI_PUBLIC"; // DomoGrid
const char* password = "microelecpub"; //toorroot7997
...
void loop()
{
  ...
  if (ESPserial.available() > 0)
  {
    ...
    {
      //char ch1 = ESPserial.read()-48;
      //char ch2=ESPserial.read()-48;
     //char temperature2=(((ch1*10)+ch2)*51)/10;
     temperature2 += float((char)ESPserial.read());  
